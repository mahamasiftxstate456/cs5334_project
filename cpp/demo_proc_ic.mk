...
ICSDKHOME=../
ICLIBHOME=/opt/oracle/instantclient_21_9/
...
PROC=$(ICSDKHOME)proc
PROC=/opt/oracle/instantclient_21_9/sdk/proc
SO_EXT=.so
I_SYM=-I

CCINCLUDES= $(I_SYM)$(ICSDKHOME)include
CCINCLUDES=  -I/opt/oracle/instantclient_21_9/sdk/include/ -I/usr/include/oracle/21/client64/ -I/usr/include/c++/8/
